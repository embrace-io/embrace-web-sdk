...
/**
 * Constructs an isolated `NamespacedStorage` backed by a fresh
 * `InMemoryStorage`. Use it when a test needs to construct a manager that
 * requires storage but does not exercise storage state directly.
 */
