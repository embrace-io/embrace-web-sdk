...
import { IdentifiableSessionPartLogRecordProcessor } from '../IdentifiableSessionPartLogRecordProcessor/IdentifiableSessionPartLogRecordProcessor.ts';
...
describe('UserSessionLogRecordProcessor', () => {
  ...
  it('should stamp the 4 session IDs on logs emitted during an active part', () => {
    ...
    memoryExporter = setupTestLogExporter([
      new IdentifiableSessionPartLogRecordProcessor({ sessionPartManager }),
