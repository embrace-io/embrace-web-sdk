...
// This code is never executed by the sdk, but we keep it as source of truth for the minified version used in packages/web-cli/src/processSourceFiles.ts
// This code can be minified with: `npx terser ./packages/web-cli/snippet/fileBundleIDsSnippet.js -c -m`
((globalKey) => {
  try {
