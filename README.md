...
a) Passing a `spanSampler` parameter implementing your custom sampling when initializing the SDK. This allows
for complete control on the sampling strategy.
a) passing a `spanSamplingRatio` with a value between 0 and 1. This will use our default sampling strategy targeting
a percentage of sampling equal to the value of `spanSamplingRatio`. This is a simple way to control the amount of traces
