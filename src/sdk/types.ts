...
type BaseSDKInitConfig = {
  ...
  /**
   * spanSampler restricts the amount of traces that are generated by the SDK.
   * If both spanSampler and spanSamplingRatio are set, spanSampler will be used.
   * If neither are set, all traces will be generated.
   */
  spanSampler?: Sampler;

  /**
   * spanSamplingRatio samples the amount of traces generated to the passed percentage using a deterministic
   * algorithm based on the traceID. spanSamplingRatio should be a number between 0 and 1, where 0 means no traces.
   * If both spanSampler and spanSamplingRatio are set, spanSampler will be used.
   * If neither are set, all traces will be generated.
   */
  spanSamplingRatio?: number;
